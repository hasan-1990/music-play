     ...
     <div className='mt-10 flex gap-8 flex-col md:flex-row md:items-end'>
        ...
        <div className='flex flex-col'>
            ...
            <p className='mt-1 '>
                ...
                . 1,234,567 likes
                .<b>50 (موزیک) song,</b>
                . حدود 3 ساعت 20 دقیقه
            </p>
        </div>
     </div> 
     <div className='grid grid-cols-3 sm:grid-cols-4 mt-10 mb-4 pl-2 text-[#a7a7a7]'>
     <p><b className='mr-4 '>#</b>عنوان</p>
     <p>البوم</p>
     <p className='hidde sm:block'>تاریخ اضافه شدن </p>
     ...
     <hr />
     {
        songsData.map((item,index)=>(
            <div onClick={()=>playwithId(item.id)} key={index} className='grid grid-cols-3 sm:grid-cols-4 p-2 items-center text-[#a7a7a7] hover:bg-[#ffffff2b] cursor-pointer'>
                ...
                <p className=' text-[15px] hidden sm:block '>روزه پیش اضافه شده (5)  </p>
